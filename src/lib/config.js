...
export const siteCard = "https://phageaustralia.org/site-launch-banner.jpg"
export const siteCardTitle = "Phage Australia"

export const siteTitle = "Phage Australia"
export const siteDescription = "Phage Australia is a network of phage labs and hospitals across Australia to support patient-monitored phage therapy."
export const siteURL = "phageaustralia.org" // no protocol
