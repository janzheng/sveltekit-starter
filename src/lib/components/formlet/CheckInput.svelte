	...
	<div class=" _form-control">
		<div id={id} class="" >
			...
			{#each options as item}
		  	<label class="block w-full |  _form-checkbox-label __checkbox | input-formlet-checkers-label mb-2" bind:this={ref} for={item['value']}>
			...
			{#if showOtherCheckbox}
				<label class="block w-full |  _form-checkbox-label __checkbox | input-formlet-checkers-label mb-2" for={`${id}-other`}>
