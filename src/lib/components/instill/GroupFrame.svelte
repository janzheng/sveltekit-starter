...
<script>
	...
	// import SubnavMobile from '$lib/components/sidekit/sidenav.svelte';
  
  export let project
  export let group = {
    name: "playground-example-1",
  }
...
<div class="Instill-Pages">

  <div id="subnav" class="Instill-tabs mt-2">
    <Subnav classes={"border-b border-gray-100 border-solid"}>
